...
create_clock -add -name FCLK -period 8.00 -waveform {0 4} [get_nets FCLK0];
...
# HACK: Cora Z7 doesn't have 8 LEDs, instead, emulate that by putting some of the LEDs on PMOD JA
