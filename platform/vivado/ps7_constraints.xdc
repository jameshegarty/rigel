...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[53]}]; #  Enet 0 / mdio / MIO[53]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[52]}]; #  Enet 0 / mdc / MIO[52]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[51]}]; #  GPIO / gpio[51] / MIO[51]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[50]}]; #  GPIO / gpio[50] / MIO[50]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[49]}]; #  UART 1 / rx / MIO[49]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[48]}]; #  UART 1 / tx / MIO[48]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[47]}]; #  SD 0 / cd / MIO[47]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[46]}]; #  SD 0 / wp / MIO[46]
set_property PACKAGE_PIN B9 [get_ports {MIO[45]}];
set_property DRIVE "8" [get_ports {MIO[45]}];
set_property SLEW "fast" [get_ports {MIO[45]}];
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[45]}]; #  SD 0 / data[3] / MIO[45]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[44]}]; #  SD 0 / data[2] / MIO[44]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[40]}]; #  SD 0 / clk / MIO[40]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[39]}]; #  USB 0 / data[7] / MIO[39]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[38]}]; #  USB 0 / data[6] / MIO[38]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[37]}]; #  USB 0 / data[5] / MIO[37]
set_property PACKAGE_PIN A9 [get_ports {MIO[36]}];
set_property DRIVE "8" [get_ports {MIO[36]}];
set_property SLEW "fast" [get_ports {MIO[36]}];
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[36]}]; #  USB 0 / clk / MIO[36]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[35]}]; #  USB 0 / data[3] / MIO[35]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[34]}]; #  USB 0 / data[2] / MIO[34]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[30]}]; #  USB 0 / stp / MIO[30]
set_property PACKAGE_PIN E8 [get_ports {MIO[29]}];
set_property DRIVE "8" [get_ports {MIO[29]}];
set_property SLEW "fast" [get_ports {MIO[29]}];
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[29]}]; #  USB 0 / dir / MIO[29]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[28]}]; #  USB 0 / data[4] / MIO[28]
set_property PACKAGE_PIN D7 [get_ports {MIO[27]}];
set_property DRIVE "8" [get_ports {MIO[27]}];
set_property SLEW "fast" [get_ports {MIO[27]}];
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[27]}]; #  Enet 0 / rx_ctl / MIO[27]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[26]}]; #  Enet 0 / rxd[3] / MIO[26]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[25]}]; #  Enet 0 / rxd[2] / MIO[25]
set_property PACKAGE_PIN B7 [get_ports {MIO[24]}];
set_property DRIVE "8" [get_ports {MIO[24]}];
set_property SLEW "fast" [get_ports {MIO[24]}];
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[24]}]; #  Enet 0 / rxd[1] / MIO[24]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[23]}]; #  Enet 0 / rxd[0] / MIO[23]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[22]}]; #  Enet 0 / rx_clk / MIO[22]
...
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[21]}]; #  Enet 0 / tx_ctl / MIO[21]
set_property PACKAGE_PIN A8 [get_ports {MIO[20]}];
set_property DRIVE "8" [get_ports {MIO[20]}];
set_property SLEW "fast" [get_ports {MIO[20]}];
set_property IOSTANDARD LVCMOS18 [get_ports {MIO[20]}]; #  Enet 0 / txd[3] / MIO[20]
