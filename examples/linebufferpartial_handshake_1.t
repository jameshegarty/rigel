...
function MAKE(T)
  ...
  local out = R.apply( "convLB", RM.stencilLinebufferPartial( types.uint(8), inputW, inputH, T, -ConvWidth+1, 0, -ConvWidth+1, 0 ), inp)
  out = R.apply("extract",RM.makeHandshake(extract),out)
  out = R.apply( "border", RM.makeHandshake( RM.borderSeq( types.uint(8), inputW/T, inputH, 1, (ConvWidth-1)/T, 0, ConvWidth-1, 0, 0 )), out ) -- cut off the junk (undefined region)
