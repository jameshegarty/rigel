...
local OffsetModule = G.Module{ "OffsetModule", R.HandshakeTrigger, SDF{1,1024},
  function(i)
    ...
    local rb0 = G.Map{G.CropSeq{{0,96,0,0},{128,64},8,ty,SDF{1,1}}}(rb[0])
    local rb1 = G.Map{G.CropSeq{{96,0,0,0},{128,64},8,ty,SDF{1,1}}}(rb[1])
