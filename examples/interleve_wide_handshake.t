...
--ignoreBin = RM.lift( "ignoreBin", BTYPE, ITYPE, 0, terra( a:&BTYPE:toTerraType(), out:&ITYPE:toTerraType()) @out = array(a._1,a._1,a._1,a._1,a._1,a._1,a._1,a._1) end, inp, S.index(inp,0) )
------------
...
B = R.apply( "plus100", RM.makeHandshake(RM.map(plus100,8)), AinFifo1 )



local AinFifo2 = R.applyMethod("L2", fifos[2],"load")

local out = R.apply("toHandshakeArray", RM.toHandshakeArray(ITYPE,{{1,2},{1,2}}), R.array2d("sa",{AinFifo2,B},2,1,false))
