...
local ITYPE = types.array2d(ATYPE,J.sel(rgba,1,4))
...
if T==2 then MHz = 95 end
if T==4 then MHz = 130 end

harness{ inFile=infile, fn=hsfn, outFile=outfile, inSize={W,H}, outSize={W,H}, MHz=MHz}
