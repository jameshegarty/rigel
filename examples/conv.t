...
convstencils = d.apply( "convtencils", d.stencil( types.uint(8),W,H,-ConvRadius, ConvRadius, -ConvRadius, ConvRadius ), inp)
...
doit = d.scanlHarness( Module, W*H, "frame_128.bmp", ITYPE,W,H, "out/conv.bmp", ITYPE, W, H)
doit()
