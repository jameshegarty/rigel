...
local inp = d.input( darkroom.StatefulHandshake( types.uint(8) ) )
local out = d.apply("toint32", d.makeHandshake(d.makeStateful(toint32)), inp)
...
harness.sim( "reduceseq_handshake", hsfn, 1, types.uint(8), inputW, inputH, types.uint(8), inputW/DOWNSAMP, inputH)
